        ...
        <div className="flex flex-col items-center gap-10 w-full xl:mt-10 justify-center px-10 pt-16 pb-5">
            {
                OnBoardingOne.map((item,index)=>(
                    <div className="flex gap-5 items-start px-14 py-8 justify-center bg-secondaryColor rounded-md" key={index}>
            ...
            }
             {
                OnBoardingTwo.map((item,index)=>(
                    <div className="flex gap-14 items-center px-14 py-8 justify-center  rounded-md" key={index}>
